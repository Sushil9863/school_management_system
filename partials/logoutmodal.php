...
<div id="logoutModal" 
    ...
    <!-- Modal Box -->
    <div class="bg-white p-6 rounded shadow-lg w-full max-w-sm" onclick="event.stopPropagation();">
        ...
        <div class="flex justify-end space-x-4">
            ...
            <form method="GET" action="<?= BASE_URL ?>/partials/logout.php">
                <input type="hidden" name="confirm" value="yes">
                <button type="submit" class="px-4 py-2 bg-red-600 text-white hover:bg-red-700 rounded">Yes, Logout</button>
            </form>
        </div>
    </div>
</div>
...
<script>
    ...
    function handleModalBackgroundClick(event) {
        // Hide modal if clicked outside the modal box
        hideLogoutModal();
    }
</script>
