...
<body class="bg-gray-100 p-6">
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <div class="flex justify-between items-start mb-6">
            ...
            <a href="manage_payments.php?class_id=<?= $class_id ?>" 
        ...
        <div id="add-payment-tab" class="tab-content hidden">
            ...
            <form method="POST" class="space-y-4 max-w-md">
                ...
                <div>
                    ...
                    <select name="payment_method" id="payment_method" class="w-full border px-4 py-2 rounded <?= isset($errors['payment_method']) ? 'border-red-500' : '' ?>" required>
                    ...
                    <?php if (isset($errors['payment_method'])): ?>
                        <p class="mt-1 text-sm text-red-600"><?= $errors['payment_method'] ?></p>
                    <?php endif; ?>
                </div>
