  ...
  <aside id="sidebar" class="w-64 bg-white shadow-lg fixed z-30 h-full transform transition-transform duration-300 translate-x-0">
    ...
    <nav class="mt-4">
      <ul class="space-y-2 text-gray-700 font-medium">
        <li><a href='superadmin_dashboard.php' class="block px-6 py-3 hover:bg-gray-200">🏠 Dashboard</a></li>
        ...
        <li><a href="sa_settings.php" class="block px-6 py-3 hover:bg-gray-200">⚙️ Settings</a></li>
        <li>
